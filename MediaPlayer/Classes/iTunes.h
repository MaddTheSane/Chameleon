...
typedef NS_ENUM(OSType, iTunesEKnd) {
...
typedef NS_ENUM(OSType, iTunesEnum) {
...
typedef NS_ENUM(OSType, iTunesEPlS) {
...
typedef NS_ENUM(OSType, iTunesERpt) {
	iTunesERptOff = 'kRpO',
	iTunesERptOne = 'kRp1',
	iTunesERptAll = 'kAll'
};

typedef NS_ENUM(OSType, iTunesEVSz) {
	iTunesEVSzSmall = 'kVSS',
	iTunesEVSzMedium = 'kVSM',
	iTunesEVSzLarge = 'kVSL'
};

typedef NS_ENUM(OSType, iTunesESrc) {
...
typedef NS_ENUM(OSType, iTunesESrA) {
...
typedef NS_ENUM(OSType, iTunesESpK) {
	iTunesESpKNone = 'kNon',
...
typedef NS_ENUM(OSType, iTunesEVdK) {
